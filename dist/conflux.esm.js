  ...
  function Entry(dataView, fileLike) {
    ...
    for (var i = 46 + this.filenameLength; i < dv.byteLength; ) {
      ...
      this._extraFields[id] = new DataView(
        _sliceInstanceProperty((_context = dv.buffer)).call(
          _context,
          start,
          start + len,
        ),
                    ...
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        return _sliceInstanceProperty(
                          (_context2 = self._fileLike),
                        )
                          .call(_context2, self.offset + 26, self.offset + 30)
                          .arrayBuffer();
                      ...
                      case 2:
                        ...
                        localFileOffset =
                          uint16e(bytes, 0) + uint16e(bytes, 2) + 30;
                        start = self.offset + localFileOffset;
                        end = start + self.compressedSize;
                        _this.reader = _sliceInstanceProperty(
                          (_context3 = self._fileLike),
                        )
                          .call(_context3, start, end)
                          .stream()
                          .getReader();
        ...
        if (!this.bitFlag && this._extraFields && this._extraFields[0x7075]) {
          ...
          return decoder.decode(
            _sliceInstanceProperty(
              (_context6 = this._extraFields[0x7075].buffer),
            ).call(_context6, 5),
          );
        }
    ...
    },
    {
      ...
      get: function get() {
        ...
        return size === MAX_VALUE_32BITS
          ? this._extraFields[1].getUint8(0)
          : size;
      },
    },
  ]);
...
function _Reader() {
  _Reader = _wrapAsyncGenerator(
    /*#__PURE__*/ _regeneratorRuntime.mark(function _callee4(file) {
      var doSeek,
        _doSeek,
        dv,
        fileslength,
          ...
          switch ((_context8.prev = _context8.next)) {
                    ...
                    return _regeneratorRuntime.wrap(function _callee3$(
                      ...
                      while (1) {
                        switch ((_context7.prev = _context7.next)) {
                          case 0:
                            _context7.next = 2;
                            return _sliceInstanceProperty(file)
                              .call(file, file.size - length)
                              .arrayBuffer();
                          ...
                          case 5:
                            ...
                            return _context7.abrupt(
                              'return',
                              new DataView(bytes.buffer, _i, EOCDR_MIN),
                            );
            ...
            case 6:
              ...
              return _awaitAsyncGenerator(
                doSeek(Math.min(EOCDR_MAX, file.size)),
              );
            ...
            case 14:
              ...
              _context8.next = 23;
              return _awaitAsyncGenerator(
                _sliceInstanceProperty(file)
                  .call(file, l, -dv.byteLength)
                  .arrayBuffer(),
              );
            ...
            case 23:
              ...
              relativeOffsetEndOfZip64CentralDir = JSBI.toNumber(
                getBigInt64(dv, 8, true),
              ); // 8 bytes
              // const numberOfDisks = dv.getUint32(16, true) // 4 bytes

              zip64centralBlob = _sliceInstanceProperty(file).call(
                file,
                relativeOffsetEndOfZip64CentralDir,
                l,
              );
  ...
  _createClass(ZipTransformer, [
    {
      ...
      value: (function () {
        var _transform = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee(entry, ctrl) {
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      ...
                      name =
                        ...
                        !_endsWithInstanceProperty(
                          (_context = _trimInstanceProperty(
                            (_context2 = entry.name),
                          ).call(_context2)),
                        ).call(_context, '/')
                          ? ''.concat(
                              _trimInstanceProperty(
                                (_context3 = entry.name),
                              ).call(_context3),
                              '/',
                            )
                          : _trimInstanceProperty(
                              (_context4 = entry.name),
                            ).call(_context4); // Abort if this a file with this name already exists

                      if (this.files[name])
                        ctrl.abort(new Error('File already exists.')); // Add this to the ordered list of filenames
                    ...
                    case 39:
                      ...
                      hdv.setUint32(
                        14,
                        JSBI.toNumber(zipObject.compressedLength),
                        true,
                      );
                      hdv.setUint32(
                        18,
                        JSBI.toNumber(zipObject.uncompressedLength),
                        true,
                      );
    ...
    },
    {
      ...
      value: function flush(ctrl) {
        ...
        _forEachInstanceProperty((_context6 = this.filenames)).call(
          _context6,
          function (fileName) {
        ...
        _forEachInstanceProperty((_context7 = this.filenames)).call(
          _context7,
          function (fileName) {
            file = _this.files[fileName];
...
var ts =
  _globalThis.TransformStream ||
  ((_globalThis$WebStream = _globalThis.WebStreamsPolyfill) === null ||
  _globalThis$WebStream === void 0
    ? void 0
    : _globalThis$WebStream.TransformStream) ||
  TransformStream;
